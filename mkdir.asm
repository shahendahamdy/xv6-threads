...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 db 04 00 00       	call   515 <mkdir>
...
free(void *ap)
{
 ...
 2e5:	a1 fc 0a 00 00       	mov    0xafc,%eax
{
 ...
 306:	73 10                	jae    318 <free+0x38>
{
 ...
 331:	5b                   	pop    %ebx
  freep = p;
 332:	a3 fc 0a 00 00       	mov    %eax,0xafc
}
 337:	5e                   	pop    %esi
 338:	5f                   	pop    %edi
 339:	5d                   	pop    %ebp
 ...
 357:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 35a:	a3 fc 0a 00 00       	mov    %eax,0xafc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 37d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 380:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 3c9:	8b 3d fc 0a 00 00    	mov    0xafc,%edi
 ...
 3f2:	e8 e9 fe ff ff       	call   2e0 <free>
  return freep;
 3f7:	a1 fc 0a 00 00       	mov    0xafc,%eax
 ...
 424:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 427:	a3 fc 0a 00 00       	mov    %eax,0xafc
}
 ...
 43e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 440:	c7 05 fc 0a 00 00 00 	movl   $0xb00,0xafc
 447:	0b 00 00 
    base.s.size = 0;
 44a:	bf 00 0b 00 00       	mov    $0xb00,%edi
    base.s.ptr = freep = prevp = &base;
 44f:	c7 05 00 0b 00 00 00 	movl   $0xb00,0xb00
 456:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 459:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 45b:	c7 05 04 0b 00 00 00 	movl   $0x0,0xb04
 462:	00 00 00 
    if(p->s.size >= nunits){
 ...
 57c:	89 d1                	mov    %edx,%ecx
{
 ...
 5a9:	0f b6 92 24 08 00 00 	movzbl 0x824(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 7a4:	eb 1a                	jmp    7c0 <printf+0x1a0>
          s = "(null)";
 7a6:	bb 1b 08 00 00       	mov    $0x81b,%ebx
        while(*s != 0){
