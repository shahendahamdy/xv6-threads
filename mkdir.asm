...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 5b 05 00 00       	call   595 <mkdir>
...
free(void *ap)
{
 ...
 365:	a1 fc 0b 00 00       	mov    0xbfc,%eax
{
 ...
 386:	73 10                	jae    398 <free+0x38>
{
 ...
 3b1:	5b                   	pop    %ebx
  freep = p;
 3b2:	a3 fc 0b 00 00       	mov    %eax,0xbfc
}
 3b7:	5e                   	pop    %esi
 3b8:	5f                   	pop    %edi
 3b9:	5d                   	pop    %ebp
 ...
 3d7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 3da:	a3 fc 0b 00 00       	mov    %eax,0xbfc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 3fd:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 400:	8b 3d fc 0b 00 00    	mov    0xbfc,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 449:	8b 3d fc 0b 00 00    	mov    0xbfc,%edi
 ...
 472:	e8 e9 fe ff ff       	call   360 <free>
  return freep;
 477:	a1 fc 0b 00 00       	mov    0xbfc,%eax
 ...
 4a4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 4a7:	a3 fc 0b 00 00       	mov    %eax,0xbfc
}
 ...
 4be:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 4c0:	c7 05 fc 0b 00 00 00 	movl   $0xc00,0xbfc
 4c7:	0c 00 00 
    base.s.size = 0;
 4ca:	bf 00 0c 00 00       	mov    $0xc00,%edi
    base.s.ptr = freep = prevp = &base;
 4cf:	c7 05 00 0c 00 00 00 	movl   $0xc00,0xc00
 4d6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 4d9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 4db:	c7 05 04 0c 00 00 00 	movl   $0x0,0xc04
 4e2:	00 00 00 
    if(p->s.size >= nunits){
 ...
 5fc:	89 d1                	mov    %edx,%ecx
{
 ...
 629:	0f b6 92 a4 08 00 00 	movzbl 0x8a4(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 824:	eb 1a                	jmp    840 <printf+0x1a0>
          s = "(null)";
 826:	bb 9b 08 00 00       	mov    $0x89b,%ebx
        while(*s != 0){
