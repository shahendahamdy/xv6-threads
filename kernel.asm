...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 9f 7a 10 80 	movl   $0x80107a9f,(%esp)
...
80102020:	68 86 78 10 80       	push   $0x80107886
...
80104203:	68 9f 7a 10 80       	push   $0x80107a9f
...
80104a6b:	74 53                	je     80104ac0 <syscall+0x70>
	curproc->readid= curproc->readid+1;  
  }
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104a6d:	8d 50 ff             	lea    -0x1(%eax),%edx
80104a70:	83 fa 16             	cmp    $0x16,%edx
80104a73:	76 2b                	jbe    80104aa0 <syscall+0x50>
    curproc->tf->eax = syscalls[num]();
  } else {
    cprintf("%d %s: unknown sys call %d\n",
80104a75:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104a76:	8d 43 6c             	lea    0x6c(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104a79:	50                   	push   %eax
80104a7a:	ff 73 10             	pushl  0x10(%ebx)
80104a7d:	68 dd 77 10 80       	push   $0x801077dd
80104a82:	e8 29 bc ff ff       	call   801006b0 <cprintf>
    curproc->tf->eax = -1;
80104a87:	8b 43 18             	mov    0x18(%ebx),%eax
80104a8a:	83 c4 10             	add    $0x10,%esp
80104a8d:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
80104a94:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104a97:	c9                   	leave  
80104a98:	c3                   	ret    
80104a99:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104aa0:	8b 14 85 00 78 10 80 	mov    -0x7fef8800(,%eax,4),%edx
80104aa7:	85 d2                	test   %edx,%edx
80104aa9:	74 ca                	je     80104a75 <syscall+0x25>
    curproc->tf->eax = syscalls[num]();
80104aab:	ff d2                	call   *%edx
80104aad:	89 c2                	mov    %eax,%edx
80104aaf:	8b 43 18             	mov    0x18(%ebx),%eax
80104ab2:	89 50 1c             	mov    %edx,0x1c(%eax)
}
...
80104aba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80104ac0:	ba 40 4d 10 80       	mov    $0x80104d40,%edx
	curproc->readid= curproc->readid+1;  
80104ac5:	83 43 7c 01          	addl   $0x1,0x7c(%ebx)
    curproc->tf->eax = syscalls[num]();
80104ac9:	ff d2                	call   *%edx
80104acb:	89 c2                	mov    %eax,%edx
80104acd:	8b 43 18             	mov    0x18(%ebx),%eax
80104ad0:	89 50 1c             	mov    %edx,0x1c(%eax)
80104ad3:	eb e0                	jmp    80104ab5 <syscall+0x65>
...
80104c14:	68 7c 78 10 80       	push   $0x8010787c
...
80104c2c:	68 7b 78 10 80       	push   $0x8010787b
...
80104c41:	68 6f 78 10 80       	push   $0x8010786f
...
80104c5f:	68 7e 78 10 80       	push   $0x8010787e
80104c64:	e8 27 b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c69:	83 ec 0c             	sub    $0xc,%esp
80104c6c:	68 60 78 10 80       	push   $0x80107860
...
80104c92:	e8 c9 fc ff ff       	call   80104960 <argint>
...
8010505d:	58                   	pop    %eax
8010505e:	5a                   	pop    %edx
8010505f:	68 7c 78 10 80       	push   $0x8010787c
...
80105078:	68 7b 78 10 80       	push   $0x8010787b
...
801056d4:	b8 e5 07 00 00       	mov    $0x7e5,%eax
801056d9:	c3                   	ret    
...
801056ef:	8b 40 7c             	mov    0x7c(%eax),%eax
}
801056f2:	c9                   	leave  
801056f3:	c3                   	ret    
...
80105717:	83 ec 08             	sub    $0x8,%esp
  exit();
8010571a:	e8 81 e6 ff ff       	call   80103da0 <exit>
...
80105730:	f3 0f 1e fb          	endbr32 
  return wait();
80105734:	e9 b7 e8 ff ff       	jmp    80103ff0 <wait>
...
80105750:	e8 0b f2 ff ff       	call   80104960 <argint>
...
80105762:	e8 e9 e9 ff ff       	call   80104150 <kill>
...
80105801:	e8 5a f1 ff ff       	call   80104960 <argint>
...
80105819:	e8 52 ed ff ff       	call   80104570 <acquire>
  ticks0 = ticks;
...
8010583d:	e8 ee e6 ff ff       	call   80103f30 <sleep>
  while(ticks - ticks0 < n){
...
80105865:	e8 c6 ed ff ff       	call   80104630 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105888:	e8 a3 ed ff ff       	call   80104630 <release>
  return 0;
...
8010594e:	00 00 ef 
  initlock(&tickslock, "time");
80105951:	68 c1 78 10 80       	push   $0x801078c1
...
801059d4:	3e ff 24 85 68 79 10 	notrack jmp *-0x7fef8698(,%eax,4)
801059db:	80 
    lapiceoi();
    break;
...
80105a31:	68 24 79 10 80       	push   $0x80107924
...
80105b4c:	68 cc 78 10 80       	push   $0x801078cc
...
80105be8:	68 f0 78 10 80       	push   $0x801078f0
80105bed:	e8 be aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105bf2:	83 c4 14             	add    $0x14,%esp
80105bf5:	68 c6 78 10 80       	push   $0x801078c6
...
80105cf3:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105cf8:	bb e8 79 10 80       	mov    $0x801079e8,%ebx
  ioapicenable(IRQ_COM1, 0);
...
801068fd:	68 f0 79 10 80       	push   $0x801079f0
...
80106bef:	68 35 7a 10 80       	push   $0x80107a35
...
80106d59:	68 6d 7a 10 80       	push   $0x80107a6d
...
80106dbb:	68 85 7a 10 80       	push   $0x80107a85
...
80106e9c:	68 a1 7a 10 80       	push   $0x80107aa1
...
80106f3f:	a3 a4 55 11 80       	mov    %eax,0x801155a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f73:	68 b2 7a 10 80       	push   $0x80107ab2
...
80107059:	68 d6 7a 10 80       	push   $0x80107ad6
8010705e:	e8 2d 93 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107063:	83 ec 0c             	sub    $0xc,%esp
80107066:	68 bc 7a 10 80       	push   $0x80107abc
