...
00000e1b <getyear>:
SYSCALL(getyear)
     e1b:	b8 16 00 00 00       	mov    $0x16,%eax
     e20:	cd 40                	int    $0x40
     e22:	c3                   	ret    

00000e23 <getreadcount>:
SYSCALL(getreadcount)
     e23:	b8 17 00 00 00       	mov    $0x17,%eax
     e28:	cd 40                	int    $0x40
     e2a:	c3                   	ret    

00000e2b <sbrk>:
SYSCALL(sbrk)
     e2b:	b8 0c 00 00 00       	mov    $0xc,%eax
     e30:	cd 40                	int    $0x40
     e32:	c3                   	ret    

00000e33 <sleep>:
SYSCALL(sleep)
     e33:	b8 0d 00 00 00       	mov    $0xd,%eax
     e38:	cd 40                	int    $0x40
     e3a:	c3                   	ret    

00000e3b <uptime>:
SYSCALL(uptime)
     e3b:	b8 0e 00 00 00       	mov    $0xe,%eax
     e40:	cd 40                	int    $0x40
     e42:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    11cb:	e8 5b fc ff ff       	call   e2b <sbrk>
  if(p == (char*)-1)
