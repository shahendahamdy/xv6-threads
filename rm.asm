...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 e3 04 00 00       	call   51d <unlink>
...
free(void *ap)
{
 ...
 305:	a1 34 0b 00 00       	mov    0xb34,%eax
{
 ...
 326:	73 10                	jae    338 <free+0x38>
{
 ...
 351:	5b                   	pop    %ebx
  freep = p;
 352:	a3 34 0b 00 00       	mov    %eax,0xb34
}
 357:	5e                   	pop    %esi
 358:	5f                   	pop    %edi
 359:	5d                   	pop    %ebp
 ...
 377:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 37a:	a3 34 0b 00 00       	mov    %eax,0xb34
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 39d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 3a0:	8b 3d 34 0b 00 00    	mov    0xb34,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 3e9:	8b 3d 34 0b 00 00    	mov    0xb34,%edi
 ...
 412:	e8 e9 fe ff ff       	call   300 <free>
  return freep;
 417:	a1 34 0b 00 00       	mov    0xb34,%eax
 ...
 444:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 447:	a3 34 0b 00 00       	mov    %eax,0xb34
}
 ...
 45e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 460:	c7 05 34 0b 00 00 38 	movl   $0xb38,0xb34
 467:	0b 00 00 
    base.s.size = 0;
 46a:	bf 38 0b 00 00       	mov    $0xb38,%edi
    base.s.ptr = freep = prevp = &base;
 46f:	c7 05 38 0b 00 00 38 	movl   $0xb38,0xb38
 476:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 479:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 47b:	c7 05 3c 0b 00 00 00 	movl   $0x0,0xb3c
 482:	00 00 00 
    if(p->s.size >= nunits){
 ...
 59c:	89 d1                	mov    %edx,%ecx
{
 ...
 5c9:	0f b6 92 3c 08 00 00 	movzbl 0x83c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 7c4:	eb 1a                	jmp    7e0 <printf+0x1a0>
          s = "(null)";
 7c6:	bb 35 08 00 00       	mov    $0x835,%ebx
        while(*s != 0){
