...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 c3 04 00 00       	call   4fd <unlink>
  ...
  exit();
  4b:	e8 5d 04 00 00       	call   4ad <exit>
      printf(2, "rm: %s failed to delete\n", argv[i]);
  50:	50                   	push   %eax
  51:	ff 33                	pushl  (%ebx)
  53:	68 fc 07 00 00       	push   $0x7fc
  58:	6a 02                	push   $0x2
  5a:	e8 c1 05 00 00       	call   620 <printf>
      break;
  ...
  6b:	6a 02                	push   $0x2
  6d:	e8 ae 05 00 00       	call   620 <printf>
    exit();
  72:	e8 36 04 00 00       	call   4ad <exit>
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
 ...
 1a9:	31 f6                	xor    %esi,%esi
{
 ...
 1c8:	50                   	push   %eax
 1c9:	6a 00                	push   $0x0
 1cb:	e8 f5 02 00 00       	call   4c5 <read>
    if(cc < 1)
...
stat(const char *n, struct stat *st)
{
 ...
 231:	e8 b7 02 00 00       	call   4ed <open>
  if(fd < 0)
 ...
 245:	50                   	push   %eax
 246:	e8 ba 02 00 00       	call   505 <fstat>
  close(fd);
 24b:	89 1c 24             	mov    %ebx,(%esp)
  r = fstat(fd, st);
 24e:	89 c6                	mov    %eax,%esi
  close(fd);
 250:	e8 80 02 00 00       	call   4d5 <close>
  return r;
...
free(void *ap)
{
 ...
 2e5:	a1 f4 0a 00 00       	mov    0xaf4,%eax
{
 ...
 306:	73 10                	jae    318 <free+0x38>
{
 ...
 331:	5b                   	pop    %ebx
  freep = p;
 332:	a3 f4 0a 00 00       	mov    %eax,0xaf4
}
 337:	5e                   	pop    %esi
 338:	5f                   	pop    %edi
 339:	5d                   	pop    %ebp
 ...
 357:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 35a:	a3 f4 0a 00 00       	mov    %eax,0xaf4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 37d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 380:	8b 3d f4 0a 00 00    	mov    0xaf4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 3c9:	8b 3d f4 0a 00 00    	mov    0xaf4,%edi
 ...
 3f2:	e8 e9 fe ff ff       	call   2e0 <free>
  return freep;
 3f7:	a1 f4 0a 00 00       	mov    0xaf4,%eax
 ...
 424:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 427:	a3 f4 0a 00 00       	mov    %eax,0xaf4
}
 ...
 43e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 440:	c7 05 f4 0a 00 00 f8 	movl   $0xaf8,0xaf4
 447:	0a 00 00 
    base.s.size = 0;
 44a:	bf f8 0a 00 00       	mov    $0xaf8,%edi
    base.s.ptr = freep = prevp = &base;
 44f:	c7 05 f8 0a 00 00 f8 	movl   $0xaf8,0xaf8
 456:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 459:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 45b:	c7 05 fc 0a 00 00 00 	movl   $0x0,0xafc
 462:	00 00 00 
    if(p->s.size >= nunits){
 ...
 57c:	89 d1                	mov    %edx,%ecx
{
 ...
 5a9:	0f b6 92 1c 08 00 00 	movzbl 0x81c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 7a4:	eb 1a                	jmp    7c0 <printf+0x1a0>
          s = "(null)";
 7a6:	bb 15 08 00 00       	mov    $0x815,%ebx
        while(*s != 0){
