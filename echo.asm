...
main(int argc, char *argv[])
{
  ...
  exit();
  6c:	e8 5c 04 00 00       	call   4cd <exit>
  71:	66 90                	xchg   %ax,%ax
  73:	66 90                	xchg   %ax,%ax
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
 ...
 305:	a1 08 0b 00 00       	mov    0xb08,%eax
{
 ...
 326:	73 10                	jae    338 <free+0x38>
{
 ...
 351:	5b                   	pop    %ebx
  freep = p;
 352:	a3 08 0b 00 00       	mov    %eax,0xb08
}
 357:	5e                   	pop    %esi
 358:	5f                   	pop    %edi
 359:	5d                   	pop    %ebp
 ...
 377:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 37a:	a3 08 0b 00 00       	mov    %eax,0xb08
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 39d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 3a0:	8b 3d 08 0b 00 00    	mov    0xb08,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 3e9:	8b 3d 08 0b 00 00    	mov    0xb08,%edi
 ...
 412:	e8 e9 fe ff ff       	call   300 <free>
  return freep;
 417:	a1 08 0b 00 00       	mov    0xb08,%eax
 ...
 444:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 447:	a3 08 0b 00 00       	mov    %eax,0xb08
}
 ...
 45e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 460:	c7 05 08 0b 00 00 0c 	movl   $0xb0c,0xb08
 467:	0b 00 00 
    base.s.size = 0;
 46a:	bf 0c 0b 00 00       	mov    $0xb0c,%edi
    base.s.ptr = freep = prevp = &base;
 46f:	c7 05 0c 0b 00 00 0c 	movl   $0xb0c,0xb0c
 476:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 479:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 47b:	c7 05 10 0b 00 00 00 	movl   $0x0,0xb10
 482:	00 00 00 
    if(p->s.size >= nunits){
 ...
 59c:	89 d1                	mov    %edx,%ecx
{
 ...
 5c9:	0f b6 92 18 08 00 00 	movzbl 0x818(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 7c4:	eb 1a                	jmp    7e0 <printf+0x1a0>
          s = "(null)";
 7c6:	bb 11 08 00 00       	mov    $0x811,%ebx
        while(*s != 0){
