...
main(int argc, char *argv[])
{
  ...
  62:	6a 01                	push   $0x1
  64:	e8 b7 05 00 00       	call   620 <printf>
  69:	83 c4 10             	add    $0x10,%esp
  exit();
  6c:	e8 3c 04 00 00       	call   4ad <exit>
  71:	66 90                	xchg   %ax,%ax
  73:	66 90                	xchg   %ax,%ax
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
 ...
 2e5:	a1 c8 0a 00 00       	mov    0xac8,%eax
{
 ...
 306:	73 10                	jae    318 <free+0x38>
{
 ...
 331:	5b                   	pop    %ebx
  freep = p;
 332:	a3 c8 0a 00 00       	mov    %eax,0xac8
}
 337:	5e                   	pop    %esi
 338:	5f                   	pop    %edi
 339:	5d                   	pop    %ebp
 ...
 357:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 35a:	a3 c8 0a 00 00       	mov    %eax,0xac8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 37d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 380:	8b 3d c8 0a 00 00    	mov    0xac8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 3c9:	8b 3d c8 0a 00 00    	mov    0xac8,%edi
 ...
 3f2:	e8 e9 fe ff ff       	call   2e0 <free>
  return freep;
 3f7:	a1 c8 0a 00 00       	mov    0xac8,%eax
 ...
 424:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 427:	a3 c8 0a 00 00       	mov    %eax,0xac8
}
 ...
 43e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 440:	c7 05 c8 0a 00 00 cc 	movl   $0xacc,0xac8
 447:	0a 00 00 
    base.s.size = 0;
 44a:	bf cc 0a 00 00       	mov    $0xacc,%edi
    base.s.ptr = freep = prevp = &base;
 44f:	c7 05 cc 0a 00 00 cc 	movl   $0xacc,0xacc
 456:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 459:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 45b:	c7 05 d0 0a 00 00 00 	movl   $0x0,0xad0
 462:	00 00 00 
    if(p->s.size >= nunits){
 ...
 57c:	89 d1                	mov    %edx,%ecx
{
 ...
 5a9:	0f b6 92 f8 07 00 00 	movzbl 0x7f8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 7a4:	eb 1a                	jmp    7c0 <printf+0x1a0>
          s = "(null)";
 7a6:	bb f1 07 00 00       	mov    $0x7f1,%ebx
        while(*s != 0){
