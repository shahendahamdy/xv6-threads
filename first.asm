...
printf(1,"THE FIRST XV6 PROGRAM %d\n",getyear());
  15:	e8 31 03 00 00       	call   34b <getyear>
...
printf(1,"NEW YEAR\n");
  2a:	58                   	pop    %eax
  2b:	5a                   	pop    %edx
  2c:	68 b2 07 00 00       	push   $0x7b2
  31:	6a 01                	push   $0x1
  33:	e8 f8 03 00 00       	call   430 <printf>
printf(1, "countr systm call %d\n",getreadcount());
  38:	e8 16 03 00 00       	call   353 <getreadcount>
  3d:	83 c4 0c             	add    $0xc,%esp
  40:	50                   	push   %eax
  41:	68 bc 07 00 00       	push   $0x7bc
  46:	6a 01                	push   $0x1
  48:	e8 e3 03 00 00       	call   430 <printf>
 ...
 38c:	89 d1                	mov    %edx,%ecx
{
 ...
 3b9:	0f b6 92 dc 07 00 00 	movzbl 0x7dc(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb d2 07 00 00       	mov    $0x7d2,%ebx
        while(*s != 0){
