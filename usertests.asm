...
00000310 <openiputtest>:
{
  ...
  sleep(1);
     ...
     383:	6a 01                	push   $0x1
     385:	e8 99 36 00 00       	call   3a23 <sleep>
  if(unlink("oidir") != 0){
    ...
    2dd8:	31 ff                	xor    %edi,%edi
{
  ...
  oldbrk = sbrk(0);
    ...
    2df6:	e8 20 0c 00 00       	call   3a1b <sbrk>
  a = sbrk(0);
    2dfb:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  oldbrk = sbrk(0);
    2e02:	89 c3                	mov    %eax,%ebx
  a = sbrk(0);
    2e04:	e8 12 0c 00 00       	call   3a1b <sbrk>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2e15:	6a 01                	push   $0x1
    2e17:	e8 ff 0b 00 00       	call   3a1b <sbrk>
    if(b != a){
  ...
  c = sbrk(1);
    2e4d:	6a 01                	push   $0x1
    2e4f:	e8 c7 0b 00 00       	call   3a1b <sbrk>
  c = sbrk(1);
    2e54:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    2e5b:	e8 bb 0b 00 00       	call   3a1b <sbrk>
  if(c != a + 1){
  ...
  a = sbrk(0);
    ...
    2e7b:	6a 00                	push   $0x0
    2e7d:	e8 99 0b 00 00       	call   3a1b <sbrk>
  ...
  p = sbrk(amt);
    ...
    2e8e:	e8 88 0b 00 00       	call   3a1b <sbrk>
  if (p != a) {
  ...
  *lastaddr = 99;
  ...
  a = sbrk(0);
    2ea8:	6a 00                	push   $0x0
    2eaa:	e8 6c 0b 00 00       	call   3a1b <sbrk>
  c = sbrk(-4096);
    2eaf:	c7 04 24 00 f0 ff ff 	movl   $0xfffff000,(%esp)
  a = sbrk(0);
    2eb6:	89 c6                	mov    %eax,%esi
  c = sbrk(-4096);
    2eb8:	e8 5e 0b 00 00       	call   3a1b <sbrk>
  ...
  c = sbrk(0);
    ...
    2ecc:	6a 00                	push   $0x0
    2ece:	e8 48 0b 00 00       	call   3a1b <sbrk>
  if(c != a - 4096){
  ...
  a = sbrk(0);
    ...
    2ee7:	6a 00                	push   $0x0
    2ee9:	e8 2d 0b 00 00       	call   3a1b <sbrk>
  c = sbrk(4096);
    2eee:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  a = sbrk(0);
    2ef5:	89 c6                	mov    %eax,%esi
  c = sbrk(4096);
    2ef7:	e8 1f 0b 00 00       	call   3a1b <sbrk>
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    2f0c:	6a 00                	push   $0x0
    2f0e:	e8 08 0b 00 00       	call   3a1b <sbrk>
  ...
  c = sbrk(4096);
    ...
    2feb:	e8 2b 0a 00 00       	call   3a1b <sbrk>
  ...
  if(sbrk(0) > oldbrk)
    ...
    3023:	6a 00                	push   $0x0
    3025:	e8 f1 09 00 00       	call   3a1b <sbrk>
    ...
    3208:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    3236:	6a 00                	push   $0x0
    3238:	e8 e6 07 00 00       	call   3a23 <sleep>
    sleep(0);
    323d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
    3244:	e8 da 07 00 00       	call   3a23 <sleep>
    kill(pid);
...
00003690 <argptest>:
{
  ...
  read(fd, sbrk(0) - 1, -1);
    ...
    36b3:	6a 00                	push   $0x0
    36b5:	e8 61 03 00 00       	call   3a1b <sbrk>
...
00003a0b <getyear>:
SYSCALL(getyear)
    3a0b:	b8 16 00 00 00       	mov    $0x16,%eax
    3a10:	cd 40                	int    $0x40
    3a12:	c3                   	ret    

00003a13 <getreadcount>:
SYSCALL(getreadcount)
    3a13:	b8 17 00 00 00       	mov    $0x17,%eax
    3a18:	cd 40                	int    $0x40
    3a1a:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    3dbb:	e8 5b fc ff ff       	call   3a1b <sbrk>
  if(p == (char*)-1)
