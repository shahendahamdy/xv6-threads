...
main(int argc, char *argv[])
{
  ...
  exit();
  44:	e8 44 07 00 00       	call   78d <exit>
    ls(".");
  49:	83 ec 0c             	sub    $0xc,%esp
  4c:	68 10 0b 00 00       	push   $0xb10
  51:	e8 aa 00 00 00       	call   100 <ls>
    exit();
  56:	e8 32 07 00 00       	call   78d <exit>
  5b:	66 90                	xchg   %ax,%ax
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
...
00000060 <fmtname>:
{
  ...
  db:	05 84 0e 00 00       	add    $0xe84,%eax
  e0:	52                   	push   %edx
  e1:	6a 20                	push   $0x20
  e3:	50                   	push   %eax
...
00000100 <ls>:
{
 ...
 113:	6a 00                	push   $0x0
 115:	57                   	push   %edi
 116:	e8 b2 06 00 00       	call   7cd <open>
 ...
 131:	56                   	push   %esi
 132:	50                   	push   %eax
 133:	e8 ad 06 00 00       	call   7e5 <fstat>
 ...
 159:	53                   	push   %ebx
 15a:	e8 56 06 00 00       	call   7b5 <close>
 ...
 19d:	6a 01                	push   $0x1
 19f:	e8 5c 07 00 00       	call   900 <printf>
    break;
 ...
 20b:	50                   	push   %eax
 20c:	53                   	push   %ebx
 20d:	e8 93 05 00 00       	call   7a5 <read>
 ...
 2a7:	6a 01                	push   $0x1
 2a9:	e8 52 06 00 00       	call   900 <printf>
 ...
 2c9:	6a 02                	push   $0x2
 2cb:	e8 30 06 00 00       	call   900 <printf>
    return;
 ...
 309:	6a 02                	push   $0x2
 30b:	e8 f0 05 00 00       	call   900 <printf>
    close(fd);
 310:	89 1c 24             	mov    %ebx,(%esp)
 313:	e8 9d 04 00 00       	call   7b5 <close>
    return;
 ...
 331:	6a 01                	push   $0x1
 333:	e8 c8 05 00 00       	call   900 <printf>
        continue;
...
free(void *ap)
{
 ...
 5c5:	a1 94 0e 00 00       	mov    0xe94,%eax
{
 ...
 5e6:	73 10                	jae    5f8 <free+0x38>
{
 ...
 611:	5b                   	pop    %ebx
  freep = p;
 612:	a3 94 0e 00 00       	mov    %eax,0xe94
}
 617:	5e                   	pop    %esi
 618:	5f                   	pop    %edi
 619:	5d                   	pop    %ebp
 ...
 637:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 63a:	a3 94 0e 00 00       	mov    %eax,0xe94
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 65d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 660:	8b 3d 94 0e 00 00    	mov    0xe94,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6a9:	8b 3d 94 0e 00 00    	mov    0xe94,%edi
 ...
 6d2:	e8 e9 fe ff ff       	call   5c0 <free>
  return freep;
 6d7:	a1 94 0e 00 00       	mov    0xe94,%eax
 ...
 704:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 707:	a3 94 0e 00 00       	mov    %eax,0xe94
}
 ...
 71e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 94 0e 00 00 98 	movl   $0xe98,0xe94
 727:	0e 00 00 
    base.s.size = 0;
 72a:	bf 98 0e 00 00       	mov    $0xe98,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 98 0e 00 00 98 	movl   $0xe98,0xe98
 736:	0e 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 73b:	c7 05 9c 0e 00 00 00 	movl   $0x0,0xe9c
 742:	00 00 00 
    if(p->s.size >= nunits){
 ...
 85c:	89 d1                	mov    %edx,%ecx
{
 ...
 889:	0f b6 92 1c 0b 00 00 	movzbl 0xb1c(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 a84:	eb 1a                	jmp    aa0 <printf+0x1a0>
          s = "(null)";
 a86:	bb 12 0b 00 00       	mov    $0xb12,%ebx
        while(*s != 0){
